...
export const SEO_CONTENT = {
  ...
  contactUs: {
    title: 'Contact US',
    description:
      'SaasAble coming soon sections are crafted to generate excitement and capture leads, providing a visually appealing placeholder for upcoming launches and a subscription option for early notifications.'
  },
